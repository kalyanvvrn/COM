	...
	public void uiTest(String functionality, WebElement webelement,
		...
		try {
			...
			breakloop: for (int i = 1; i <= ObjectSheetRowcount; i++) {
				...
				MutableCell DesktopApplicabilityValue = objectSheet.getCellAt(
						3, i);
				MutableCell DesktopXcoordinateValue = objectSheet.getCellAt(4,
						i);
				MutableCell DesktopYCoordinateValue = objectSheet.getCellAt(5,
						i);
				MutableCell DesktopWidthValue = objectSheet.getCellAt(6, i);
				MutableCell DesktopHeightValue = objectSheet.getCellAt(7, i);
				MutableCell TabletApplicabilityValue = objectSheet.getCellAt(8,
						i);
				MutableCell TabletXCoordinateValue = objectSheet
						.getCellAt(9, i);
				MutableCell TabletYCoordinateValue = objectSheet.getCellAt(10,
						i);
				MutableCell TabletWidthValue = objectSheet.getCellAt(11, i);
				MutableCell TabletHeightValue = objectSheet.getCellAt(12, i);
				MutableCell MobileApplicabilityValue = objectSheet.getCellAt(
						13, i);
				MutableCell MobileXCoordinateValue = objectSheet.getCellAt(14,
						i);
				MutableCell MobileYCoordinateValue = objectSheet.getCellAt(15,
						i);
				...
				String DesktopApplicability = DesktopApplicabilityValue
						.getTextValue();
				if (DesktopApplicability.equals("YES")) {
					String DesktopXcoordinate = DesktopXcoordinateValue
							.getTextValue();
					String DesktopYCoordinate = DesktopYCoordinateValue
							.getTextValue();
				...
				if (TabletApplicability.equals("YES")) {
					String TabletXCoordinate = TabletXCoordinateValue
							.getTextValue();
					String TabletYCoordinate = TabletYCoordinateValue
							.getTextValue();
				...
				if (MobileApplicability.equals("YES")) {
					String MobileXCoordinate = MobileXCoordinateValue
							.getTextValue();
					String MobileYCoordinate = MobileYCoordinateValue
							.getTextValue();
			...
			System.out.println("Object does not exists on the screen");
			// /Status = "Fail";
			// Reports(testCaseno, testCaseDescription, Status, j);
